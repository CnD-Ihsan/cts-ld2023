    ...
    <head>
        ...
        <style>
            ...
            .animated-box {
                ...
                text-align: center;
                border-radius: 4px;
                background: linear-gradient(0deg, black, purple 70%) no-repeat;
                opacity: 0.9;
            }
            ...
            bottom: 0;
            border-radius: 4px;
            background: linear-gradient(120deg, pink, white, purple);
            ...
            #confetti{
                ...
                width: 100%;
                z-index: 30;
                cursor: url('img/guitar-cur.png'), grabbing;
            }
  ...
  animation:moving-grid 0.5s infinite linear;
    ...
    <body class="antialiased">
        ...
        <div class="tablewrapper">
                ...
                @foreach($gifts as $key => $gift)
                    ...
                    <div class="col-sm-2 mb-4 card bg-transparent border-0">
                        <div class="card-body animated-box in">
                            <div class="card-image"><img id="placeholder{{ $key }}" src="img/gq-v.gif" alt="whut" class="gq mx-auto {{ $gifts[$key]->type == 'grand' ? 'add_gold grand' : '' }}"></div>
                            <div class="card-text mt-2">
                                <div id="numVal{{ $key }}" class="" style="font-size: 4rem;" disabled hidden>{{ $users[$key]->id }}</div>
                                <div id="numGif{{ $key }}" class=""><img src="img/gift/number1.gif" class="numGif" alt="num"> </div>
                            </div>
                        </div>
                    </div>
            ...
            {{-- <div class="row" style="margin:7%;"></div>  --}}
            @if(count($gifts) > 5)
            <div class="row justify-content-center">
                @foreach($gifts as $key => $gift)
                    @if($key < 5)
                        @continue
                    @endif
                    <div class="col-sm-2 mb-4 card bg-transparent">
                        <div class="card-body animated-box in">
                            <div class="card-image"><img id="placeholder{{ $key }}" src="img/gq-v.gif" alt="whut" class="gq mx-auto {{ $gifts[$key]->type == 'grand' ? 'add_gold grand' : '' }}"></div>
                            <div class="card-text mt-2">
                                <div id="numVal{{ $key }}" class="" style="font-size: 4rem;" disabled hidden><a href="">{{ $users[$key]->id }}</a> </div>
                                <div id="numGif{{ $key }}" class=""><img src="img/gift/number1.gif" class="numGif" alt="num"> </div>
                            </div>
                        </div>
                    </div>
            ...
            {{-- <div class="row justify-content-center">
                ...
                <div class="col-sm card text-center bg-transparent">
                    <div class="card-body">   
                        <a href="" class="down-arrow" hidden id="b3" role="button"><img src="img/poker2.png" height="250px" width="250px"></a>
                    </div>
                </div>
                <div class="col-sm"></div>
            </div> --}}
        ...
        <div class="background-80s animated-clouds stars" style="--background-height:100vh">
            ...
            <div class="text">
              <div class="chrome shine" data-text="80'S NIGHT">80<span class="spark"></span>'S NIGHT</div>
              <div class="outrun glow">CTS Lucky Draw 2022</div>    
            </div>
          </div>
...
<script>
    ...
    function changePic(i){
        ...
        if (element[i].src.match("img/gq-v.gif") && element[i].classList.contains("shake_gq")) {
            ...
            element[i].src = "img/gq-sepia.gif";
        }
        else if(element[i].src.match("img/gq-sepia.gif")){
            element[i].src = "img/prizes/" + document.getElementById("img" + i).value + ".png";
        }
        else{
            element[i].src = "img/gq-v.gif";
        }
    }
